...
type TJackpot618 struct {
	...
	RedeemCode       string `orm:"column(redeemCode);size(100);null"`
	Award            string `orm:"column(award);size(50);null"`
	Status           int    `orm:"column(status);null"`
	Province         string `orm:"column(province);size(20);null"`
	...
	Telephone        string `orm:"column(telephone);size(50);null"`
	TrugstoreAddress string `orm:"column(trugstoreAddress);size(150);null"`
	ZipCode          string `orm:"column(zipCode);size(20);null"`
	ReceiveStatus    int    `orm:"column(receiveStatus);null"`
	UpdateTime       string `orm:"column(UpdateTime);size(255);null"`
}
